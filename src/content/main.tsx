...
import { isWikipediaArticlePageUrl } from './wikiArticleUrl'

function injectWikiPinUi() {
...
// Manifest limits injection to *.wikipedia.org/wiki/*; guard aligns with excludes (e.g. Special:).
if (isWikipediaArticlePageUrl(window.location.href)) {
  injectWikiPinUi()
}
